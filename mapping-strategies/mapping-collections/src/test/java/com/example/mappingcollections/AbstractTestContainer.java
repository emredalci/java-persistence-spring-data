package com.example.mappingcollections;
...
@SpringBootTest(classes = MappingCollectionsApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
