...
import com.example.mappingvaluetypesusertype.repository.ItemRepository;
...
@SpringBootTest(classes = MappingValueTypesUserTypeApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
